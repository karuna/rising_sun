...
namespace AutoAssess.Web.Admin
{
	public class Global : System.Web.HttpApplication
	{
		...
		{
			IPersistenceConfigurer config = PostgreSQLConfiguration.PostgreSQL82.ConnectionString("Server=" + ConfigurationManager.AppSettings["PostgreSQL"] + ";Port=5433;Database=autoassess_web;User Id=postgres;Password=password;SSL=true;");
			...
			config = PostgreSQLConfiguration.PostgreSQL82.ConnectionString("Server=" + ConfigurationManager.AppSettings["PostgreSQL"] + ";Port=5433;Database=autoassess;User Id=postgres;Password=password;SSL=true;");
